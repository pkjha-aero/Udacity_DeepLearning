...
model = nn.Sequential(nn.Linear(input_size, hidden_sizes[0]),
                      ...
                      # No need to use softmax, just pass raw output to loss function

# Define the loss
criterion = nn.CrossEntropyLoss() # Use cross-entropy with softmax
...
img_idx = 0
helper.view_classify(images[img_idx].view(1, 28, 28), logits[img_idx])
...
img_idx = 0
helper.view_classify(images[img_idx].view(1, 28, 28), torch.exp(logits[img_idx]))
