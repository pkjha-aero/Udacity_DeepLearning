...
## Forward pass
hidden_layer_input = np.dot(x, weights_input_hidden) # [h_j] = x_i*W_ij, 1X2 matrix
hidden_layer_output = sigmoid(hidden_layer_input) # a_j = f(h_j), 1X2 matrix

output_layer_in = np.dot(hidden_layer_output, weights_hidden_output) # o_k = a_j*W_jk, 1X1 matrix
